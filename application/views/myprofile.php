...
<div id="page-wrapper">
  <div class="container-fluid panel-footer">          
      <a data-toggle="tooltip" type="button" class="btn btn-sm btn-success Edit-profile"><i class="glyphicon glyphicon-edit"></i> Edit Account </a>
      <a data-toggle="tooltip" type="button" class="btn btn-sm btn-danger delete"><i class="glyphicon glyphicon-remove"></i> Delete Account </a>
  </div>  
...
<script>
    ...
    link = "<?php echo base_url()."Settingcont/removeUser";?>";
