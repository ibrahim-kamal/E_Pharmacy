...
<div id="page-wrapper">
	<div class="com-form card my-4">
		...
		<div class="card-body">
		  ...
		  <form enctype="multipart/form-data" id="com-form"class="addComment" method="POST" action="<?php echo base_url()."Articlecont/EditArticle";?>">
		    ...
		    <button type="submit" class="add btn btn-primary">Edit Article</button>
		  </form>
		</div>
	</div>
</div>
