...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-lg-8">
      ...
      <!-- Title -->
      <h1 class="mt-4"><?php echo $data['article_title']?></h1>
      ...
      <!-- Post Content -->
      <p class="lead"><?php echo $data['article_subject']?></p>
...
<script>
  ...
  $('body').on('click','.add',function(e){
    ...
    var link = "<?php echo base_url().'Articlecont/addComment'?>" ;
    // if(title.length > 4 && Comment.length > 4){
      $.ajax({
            ...
            data: {title:title,comment:Comment,id:"<?php echo $data['article_ID']?>"},
   ...
   $('body').on('click','.remove',function(e){
    ...
    var link = "<?php echo base_url().'Articlecont/removecomment'?>" ;
     $.ajax({
            url: link,
   ...
   $('body').on('click','.EditComment',function(e){
    ...
    var titleelement   = $('.title');
    var Commentelement = $('.comment');
    var link = "<?php echo base_url().'Articlecont/editComment'?>" ;
    // if(title.length > 4 && Comment.length > 4){
      $.ajax({
            url: link,
