...
<div id="page-wrapper">
	<div class="com-form card my-4">
		...
		<div class="card-body">
		  ...
		  <form enctype="multipart/form-data" id="com-form"class="addComment" method="POST" action="<?php echo base_url()."Questioncont/EditQuestion";?>">
		    <div class="form-group">
		      <input style="display:none;" name="data-id" value="<?php echo $ID;?>">
		      ...
		      <img class="imgimg" title="click to change article img" src="<?php echo $img;?>" width="500" height="300">
		    ...
		    <button type="submit" class="add btn btn-primary">Edit Question</button>
		  </form>
		</div>
	</div>
</div>
