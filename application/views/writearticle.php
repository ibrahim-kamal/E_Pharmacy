...
<div id="page-wrapper">
	<div class="com-form card my-4">
		<h5 class="card-header">write new article:</h5>
		<div class="card-body">
		  <div class="error">
		  	<?php if(isset($err)){
		  		echo $err;
		  ...
		  <form enctype="multipart/form-data" id="com-form"class="addComment" method="POST" action="<?php echo base_url()."Articlecont/addArticle";?>">
		    ...
		    <button type="submit" class="add btn btn-primary">Add Article</button>
		  </form>
		</div>
	</div>
</div>
